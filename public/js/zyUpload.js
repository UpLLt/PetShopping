		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
		            ...
		            html += '				<div id="status_info" style="display:none;" class="info">选中0张文件</div>';
		            html += '				<div class="btns">';
		            html += '					<div style="display:none;" class="webuploader_pick">继续选择</div>';
		            //html += '					<div class="upload_btn">开始上传</div>';
		            html += '					<p id="set_mess">请上传6张宠物图片（图片最大3M / 不能上传相同图片）</p><p></p>';
		            html += '				</div>';
		            html += '			</div>';
					html += '		</div>';
